...
import jsonUrl2 from './static/fonts/helvetiker_regular.typeface.json?url'
...
const jsonURL = new URL('./static/fonts/helvetiker_regular.typeface.json',import.meta.url);
console.log(jsonURL,jsonUrl2)
fontLoader.load(
